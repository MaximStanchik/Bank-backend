...
create table Userr_Account (ID number(10) generated by default on null as identity,
...
create table User_Support_Request (ID number(10) generated by default on null as identity,
                                   ...
                                   constraint FK_User_Support_Request_Account foreign key (ACCOUNT_ID) references Userr_Account(ID)
);
...
create table Account_Transaction (ID number(10) generated by default on null as identity,
                                  ...
                                  constraint FK_Transaction_Account_From foreign key (ACCOUNT_ID_FROM) references Userr_Account(ID),
                                  constraint FK_Transaction_Account_To foreign key (ACCOUNT_ID_TO) references Userr_Account(ID)
);
...
create table Card (ID number(10) generated by default on null as identity,
                   ...
                   constraint FK_Card_Account foreign key (ACCOUNT_ID) references Userr_Account(ID)
);
...
create table Credits (ID number(10) generated by default on null as identity,
                      ...
                      constraint FK_Credits_Account foreign key (ACCOUNT_ID) references Userr_Account(ID)
);
